...
## [16.10.0](https://github.com/rbutoi/topgrade/compare/v16.9.0...v16.10.0) - 2026-02-11

### Added

- *(executor)* add Executor::always() for commands that must run in dry-run mode
- show version range in self-update message ([#1752](https://github.com/rbutoi/topgrade/pull/1752))
- *(uv)* run uv python upgrade ([#1747](https://github.com/rbutoi/topgrade/pull/1747))
- `--auto-retry [<COUNT>]` flag and `--no-retry` deprecation ([#1603](https://github.com/rbutoi/topgrade/pull/1603))

### Fixed

- use `edit` crate for --edit-config editor resolution ([#1759](https://github.com/rbutoi/topgrade/pull/1759))
- *(vim)* AstroNvim - wait for AstroUpdateCompleted and finish. ([#1744](https://github.com/rbutoi/topgrade/pull/1744))

### Other

- *(deps)* update michidk/winget-updater action to v1.1.7 ([#1757](https://github.com/rbutoi/topgrade/pull/1757))
- split non-step code from steps/tmux.rs to tmux.rs ([#1756](https://github.com/rbutoi/topgrade/pull/1756))
- *(clippy)* ban Command::new via clippy disallowed-methods rule
- *(steps)* use ctx.execute().always() for read-only commands
- harden workflow by SHA-pinning rust-toolchain action ([#1731](https://github.com/rbutoi/topgrade/pull/1731))
- *(deps)* update vmactions/openbsd-vm digest to d6c29ce ([#1751](https://github.com/rbutoi/topgrade/pull/1751))
- *(deps)* update pyo3/maturin-action action to v1.50.0 ([#1743](https://github.com/rbutoi/topgrade/pull/1743))
- *(msrv)* run msrv check on multiple platforms ([#1749](https://github.com/rbutoi/topgrade/pull/1749))
- format release_to_homebrew.yml workflow ([#1748](https://github.com/rbutoi/topgrade/pull/1748))
- remove hard to read condition in retry logic ([#1745](https://github.com/rbutoi/topgrade/pull/1745))
- *(typos)* ignore CHANGELOG.md ([#1742](https://github.com/rbutoi/topgrade/pull/1742))
- *(deps)* update release-plz/action digest to 52440b5 ([#1740](https://github.com/rbutoi/topgrade/pull/1740))
- *(deps)* update actions/checkout digest to de0fac2 ([#1726](https://github.com/rbutoi/topgrade/pull/1726))
- *(deps)* update release-plz/action digest to 20b2393 ([#1733](https://github.com/rbutoi/topgrade/pull/1733))
- *(deps)* update vmactions/openbsd-vm digest to 271a1ba ([#1736](https://github.com/rbutoi/topgrade/pull/1736))
- *(deps)* update github/codeql-action action to v4.32.2 ([#1737](https://github.com/rbutoi/topgrade/pull/1737))
- *(readme)* add Discord badge ([#1728](https://github.com/rbutoi/topgrade/pull/1728))
- *(pre-commit)* switch to typos mirror to fix autoupdates ([#1734](https://github.com/rbutoi/topgrade/pull/1734))
- fix CodeQL missing permissions in winget workflow ([#1732](https://github.com/rbutoi/topgrade/pull/1732))
- *(deb)* simplify config and remove revision ([#1724](https://github.com/rbutoi/topgrade/pull/1724))
